...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	impl_name: create_runtime_str!("polkadot-paseo"),
	authoring_version: 0,
	spec_version: 10020,
	impl_version: 0,
...
parameter_types! {
	...
	// TODO: Set a custom prefix for Paseo
	// Set to use polkadot prefix for now
...
impl Get<u32> for MaybeSignedPhase {
	fn get() -> u32 {
		...
		// the fallback unsigned phase is able to compute elections on Paseo.
...
// TODO: choose sensible bonding/unbonding times
parameter_types! {
...
// TODO: check parameters of BenchmarkingConfig
...
mod remote_tests {
	...
	async fn run_migrations() {
		...
		let transport: Transport =
			var("WS").unwrap_or("wss://paseo-rpc.polkadot.io:443".to_string()).into();
