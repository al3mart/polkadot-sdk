...
pub mod system_parachain {
	...
	/// TODO: Add contracts parachain
	pub const CONTRACTS_ID: u32 = 1005;
	frame_support::match_types! {
		pub type SystemParachains: impl Contains<MultiLocation> = {
			MultiLocation { parents: 0, interior: X1(Parachain(ASSET_HUB_ID | COLLECTIVES_ID | BRIDGE_HUB_ID | CONTRACTS_ID ))}
		};
	}
}
